...
dependencies {
    // NeoForge
    implementation group: 'net.darkhax.attributefix', name: 'attributefix-neoforge-1.21.4', version: '21.4.0'

    // Forge
    implementation group: 'net.darkhax.attributefix', name: 'attributefix-forge-1.21.4', version: '21.4.0'

    // Fabric & Quilt
    modImplementation group: 'net.darkhax.attributefix', name: 'attributefix-fabric-1.21.4', version: '21.4.0'

    // Common / MultiLoader / Vanilla
    compileOnly group: 'net.darkhax.attributefix', name: 'attributefix-common-1.21.4', version: '21.4.0'
}
```
<!-- maven-end -->
