...
dependencies {
     // NeoForge
     implementation group: 'net.darkhax.attributefix', name: 'attributefix-neoforge-26.2', version: '26.2.0.0'
     // Fabric
     implementation group: 'net.darkhax.attributefix', name: 'attributefix-fabric-26.2', version: '26.2.0.0'
     // Common / MultiLoader / Vanilla / No Loader
     implementation group: 'net.darkhax.attributefix', name: 'attributefix-common-26.2', version: '26.2.0.0'
}
```
